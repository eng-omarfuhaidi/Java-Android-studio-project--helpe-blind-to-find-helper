...
public class BottomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findPeopleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent findPeopleIntent = new Intent(BottomActivity.this, FindPeopleActivity.class);
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId())
            {
                case R.id.navigation_home:
                    Intent mainintent =new Intent(BottomActivity.this,BottomActivity.class);
                    startActivity(mainintent);
                    break;


                case R.id.navigation_settings:
                    Intent settingsintent =new Intent(BottomActivity.this,SettingsActivity.class);
                    startActivity(settingsintent);
                    break;


                case R.id.navigation_notifications:
                    Intent Noteintent =new Intent(BottomActivity.this,NotificationsActivity.class);
                ...
                case R.id.navigation_logout:
                    ...
                    Intent logoutintent =new Intent(BottomActivity.this,SignupActivity.class);
            ...
            usersRef.child(listUserId).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot)
                {
                    ...
                    holder.callBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v)
                        {
                            Intent callingIntent = new Intent(BottomActivity.this, CallingActivity.class);
    ...
    private void validateUser()
    {
        ...
        reference.child("Users").child(currentUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (!dataSnapshot.exists())
                {
                    Intent settingIntent = new Intent(BottomActivity.this, SettingsActivity.class);
