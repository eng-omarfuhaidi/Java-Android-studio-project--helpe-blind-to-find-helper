                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if (dataSnapshot.hasChild(receiverUserID))
                        {
                            ...
                            if (requestType.equals("sent"))
                            {
                                ...
                                add_friend.setText("الغاء الطب ");
                            }
                            else if (requestType.equals("received"))
                            {
                                currentState = "request_received";
                                add_friend.setText("قبول الطلب");
                                    ...
                                    .addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(DataSnapshot dataSnapshot)
                                        {
                                            if (dataSnapshot.hasChild(receiverUserID))
                                            {
                                                ...
                                                add_friend.setText("حذف جهة الاتصال");
                                            }
                                            else
                                            {
                                                currentState = "new";
                            ...
                            friendRequestRef.child(receiverUserID).child(senderUserId)
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task)
                                        {
                                            ...
                                            {
                                                currentState = "request_sent";
                                                add_friend.setText("الغاء الطلب");
                                                Toast.makeText(ProfileActivity.this, "تم ارسال الطلب", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                        }
                                                                    ...
                                                                    friendRequestRef.child(receiverUserID).child(senderUserId)
                                                                            ...
                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                ...
                                                                                public void onComplete(@NonNull Task<Void> task)
                                                                                {
                                                                                    ...
                                                                                    {
                                                                                        currentState = "friends";
                                                                                        add_friend.setText("تم حذف جهة الاتصال ");
